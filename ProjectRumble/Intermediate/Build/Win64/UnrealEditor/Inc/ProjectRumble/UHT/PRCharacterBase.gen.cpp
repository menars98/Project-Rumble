...
struct Z_CompiledInDeferFile_FID_Users_muham_Documents_GitHub_Project_Rumble_ProjectRumble_Source_ProjectRumble_Public_Characters_PRCharacterBase_h__Script_ProjectRumble_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_APRCharacterBase, APRCharacterBase::StaticClass, TEXT("APRCharacterBase"), &Z_Registration_Info_UClass_APRCharacterBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APRCharacterBase), 3473500846U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_muham_Documents_GitHub_Project_Rumble_ProjectRumble_Source_ProjectRumble_Public_Characters_PRCharacterBase_h__Script_ProjectRumble_3145674447(TEXT("/Script/ProjectRumble"),
