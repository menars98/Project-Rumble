...
{
	TArray<TEnumAsByte<EObjectTypeQuery>> NAVOverlapQuery_Local;
	TArray<AActor*> ActorsToIgnoreForCollision_Local;
	TArray<UPrimitiveComponent*> overlappingComponents;
	NAVOverlapQuery_Local.Add(UEngineTypes::ConvertToObjectType(ECC_GameTraceChannel3));

	FTransform transform = FTransform(ComponentAt);

	UKismetSystemLibrary::ComponentOverlapComponents(Component, transform, NAVOverlapQuery_Local, UDoNNavigationVolumeComponent::StaticClass(), ActorsToIgnoreForCollision_Local, overlappingComponents);
